...
ALTER TABLE  statistiche.hex_zona3_roma_150m  ADD COLUMN IF NOT EXISTS w_heal double precision;
ALTER TABLE  statistiche.hex_zona3_roma_150m  ADD COLUMN IF NOT EXISTS w_edu double precision;
ALTER TABLE  statistiche.hex_zona3_roma_150m  ADD COLUMN IF NOT EXISTS w_mob double precision;
...
WITH spatial_interpolation AS (
    ...
    FROM statistiche.hex_zona3_roma_150m h
...
UPDATE statistiche.hex_zona3_roma_150m h
SET 
...
UPDATE statistiche.hex_zona3_roma_150m 
